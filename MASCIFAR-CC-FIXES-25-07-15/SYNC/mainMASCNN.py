...
def main():
    ...
    parser.add_argument('--ds', type=str, default='MNIST', choices=['MNIST', 'CIFAR10', 'CIFAR100'],  # JL-CIFAR100
                        help="Dataset to process (default: MNIST, options: MNIST, CIFAR10, CIFAR100)")  # JL-CIFAR100
    args = parser.parse_args()

    # ---- DYNAMIC GPU SELECTION ACROSS ALL AVAILABLE GPUs ----
    use_gpu = False
    ...
    if args.ds == 'MNIST':
        ...
        y = dataset.targets
    elif args.ds == 'CIFAR100':  # JL-CIFAR100
        transform = transforms.Compose([
            transforms.ToTensor(),
    ...
    args.num_classes = num_classes  # JL-CIFAR100
