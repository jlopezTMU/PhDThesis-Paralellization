...
public class ControllerAgentGui extends JFrame implements ActionListener {
	...
	// JL 2025-04-24 for weight synchronization
	private Map<String, double[]> receivedWeightsMap = new HashMap<>();
	private int expectedAgents = 2; // Set this to your number of RecommenderAgents
	...
	private void createTextFields()
	{
		...
		String[] algorithmsSelection = {"Similarity", "K-Means", "SVM", "DNN", "Doc2Vec", "Common-Neighbors", "K-meansEuclidean"};
	...
	private void createPanels()
	{
		...
		labNameTitle = BorderFactory.createTitledBorder(empty,"DSMP Lab Dr. Abdolreza Abhari, Sepideh Banihashemi");
		...
		labNameLabel = new JLabel("DSMP Lab: V3.1");
