...
class ParallelizationModel(Model):
    def __init__(self, X, y, device, args):
        ...
        self.device = device
        self.args = args
        self.schedule = SimultaneousActivation(self)  # Scheduler to manage agent activation
    ...
    def step(self):
        self.schedule.step()  # Advances the simulation by one step

        # Aggregate results and processing times
