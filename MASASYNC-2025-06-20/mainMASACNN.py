...
class ParallelizationModel(Model):
    ...
    def step(self):
        ...
        # --- CC CHANGE: Collect and accumulate CC for this epoch ---
        epoch_cc = 0
        for agent in self.schedule.agents:
            ...
            epoch_cc += agent.last_cc    # --- CC CHANGE ---

        self.total_comm_cost += epoch_cc   # --- CC CHANGE ---
        ...
        print(f"Cumulative Communication Cost until now: {self.total_comm_cost} bytes")  # --- CC CHANGE ---
    ...
    def run_model(self, epochs):
        ...
        for epoch in range(epochs):
            ...
            self.step()
        print(f"\nGRAND TOTAL Communication Cost over all epochs: {self.total_comm_cost} bytes")  # --- CC CHANGE ---
