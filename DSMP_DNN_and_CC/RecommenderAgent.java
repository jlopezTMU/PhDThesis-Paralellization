...
//		usersRecTweetCountsReceived = new int[usersRec.size()];
	...
	private class RecommenderServiceBehaviour extends CyclicBehaviour {	
		...
		public int processedRecordsCounter = 0;


		public void action() {
			
			/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
			ACLMessage msgJL = myAgent.receive();
			if (msgJL == null) {
				block();
				return;
			}
			processedRecordsCounter++;
			System.out.println("[JL] Processed records count: " + processedRecordsCounter);
			if (allUniqueDocTerms == null) {
				System.out.println("[JL] ERROR: allUniqueDocTerms is null!");
			} 
			//else {
			//	System.out.println("[JL] allUniqueDocTerms size: " + RecommenderAgent.this.allUniqueDocTerms.size());
			//	System.out.println("[JL] allUniqueDocTerms contents: " + RecommenderAgent.this.allUniqueDocTerms);
			//}
			
			// Check any other variable you suspect might be null:
			//if (RecommenderAgent.this.allUserDocumentsTFIDF == null) {
			//	System.out.println("[JL] ERROR: allUserDocumentsTFIDF is null!");
			//}
			//////////////////////////////////////////////////////////////////////////////////////////////////////////////
			if (!getUserRecList)
			{
...
//					myGui.appendResult(agentName+"\nTotal Tweets Processed: " + tweetCount + " TP:" + round(completionTimeTextProcessing/1000000.00,2) + "ms TFIDF:" + round(completionTimeTFIDF/1000000.00,2) + "ms K-means:" + round(completionTimeAlgorithm/1000000.00,2) + "ms Total:" + round((completionTimeTextProcessing+completionTimeTFIDF+completionTimeAlgorithm)/1000000.00,2)+"ms");
				...
				else if (algorithmRec == MLP)
				{
					...
					*/
					...
					//Sep 30-2023 MultiLayerPerceptron multiLayer = new MultiLayerPerceptron(TransferFunctionType.TANH, numUniqueDocTerms, HIDDEN_NEURONS, HIDDEN_NEURONS, numFollowees);
